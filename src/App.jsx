...
const App = () => {
    const MenuSelectstate = useState('');

    return (<>
        <Header>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="150" height="72" viewBox="0 0 300.000000 144.000000" preserveAspectRatio="xMidYMid meet">
            ...
            <nav>
                <Ul>
                    <Li onClick = {e => {alert('준비 중입니다.')}}>About Me</Li>
                    <Li onClick = {e => {alert('준비 중입니다.')}}>Portfolio</Li>
                    <Li onClick = {e => {alert('준비 중입니다.')}}>Blog</Li>
                </Ul>
            </nav>
        </Header>
        <Container>
