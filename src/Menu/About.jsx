        ...
        <Mainprofile>
            <div>
                ...
                <div>설명 : 대학교 4학년때 인공지능 수강과목의 수업을 들으면서 인공지능이라는 학문에
                    ...
                    관련 링크 : <a target="_blank"
                               href="https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE07187579&language=ko_KR">
            ...
            <div>
                <p>제가 가진 강점</p>
                <div>
                    모든 현상에 있어서 일정한 규칙을 찾는 속도가 보통사람들보다 빠릅니다. 그리고 그 규칙을 적절하게 응할 수 있는 능력을 가지고 있습니다.
                </div>
                <div>
                    다른 사람들보다 기억에 대한 실생활의 활용능력이 좋아서, 여러 현상에 오감에 대해서 기억해서 실생활의 적재적소에 활용할 수 있습니다.
                </div>
                <p>제가 가진 단점(부족한 점)</p>
                <div>
                    개발의 경우 현재까지 여러 프로젝트의 개발을 혼자 맡아서 여러 인원과 협업하는 개발 프로젝트일 경우 소통능력은 다소 부족합니다.
                </div>
                <div>
                ...
                <div>
                    ...
                    <div>3. (인건비 절약을 위한)자동화 프로그램이 필요하신 분</div>
                    <div>위 조건에 의거하여 서비스가 필요하신 분들에게 소중한 사람이 되고 싶습니다.</div>
                </div>
            </div>
        </Mainprofile>
    </div>)
